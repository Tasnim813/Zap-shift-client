...
const RevewCart = ({reveiw}) => {
    ...
    return (
        /* Mobile-e card-er padding ektu komiye p-6 kora hoyeche (md:p-8) */
        <div className="card w-full max-w-md bg-[#fce4e4] shadow-xl p-6 md:p-8 rounded-2xl border border-gray-100 mx-auto h-full">
            
            <div className="text-[#b5c2c2] mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-10 h-10 md:w-12 md:h-12" viewBox="0 0 24 24">
            ...
            {/* Mobile-e font size ektu scaling kora hoyeche */}
            <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6 font-medium line-clamp-4 md:line-clamp-none">
                {review}
            </p>
            ...
            <div className="flex items-center gap-4">
                <div className="avatar">
                    <div className="w-10 md:w-12 rounded-full overflow-hidden">
                        <img src={user_photoURL} alt={userName} />
                    </div>
                </div>
                
                <div className="overflow-hidden">
                    <h3 className="font-bold text-[#1a3d3d] text-lg md:text-xl truncate">{userName}</h3>
                    <p className="text-gray-500 font-medium text-xs md:text-sm truncate">{user_email}</p>
                </div>
            </div>
        </div>
    );
